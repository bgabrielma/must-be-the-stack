...
Cohesion: 0.38
Nodes (7): graphify reference: query.md, graphify (knowledge graph tool), /graphify explain, /graphify path, /graphify query, Constrained query vocabulary expansion, reflect / LESSONS.md work-memory loop

### Community 4 - "docs/adr (Architecture Decision Records)"
Cohesion: 0.31
Nodes (10): Domain docs, ADR-0001 doc: Shared curriculum per Subject, ADR-0002 doc: GitHub Actions as Evaluator sandbox, Decision: PWA over native mobile for v1, ADR-0003 doc: PWA over native mobile for v1, Decision: Rails backend + React frontend, split-ecosystem pnpm monorepo, ADR-0004 doc: Polyglot stack, split-ecosystem monorepo, Decision: Solid Queue over Sidekiq for background jobs (+2 more)
...
Cohesion: 0.67
Nodes (3): graphify reference: add-watch.md, /graphify add, --watch (auto-rebuild watcher)

### Community 11 - "graphify reference: hooks.md"
Cohesion: 0.67
Nodes (3): graphify reference: hooks.md, graphify claude install (native CLAUDE.md integration), graphify post-commit hook

## Knowledge Gaps
- **23 isolated node(s):** `graphify Skill Trigger Config (.claude/CLAUDE.md)`, `graphify reference: github-and-merge.md`, `devcontainer app service`, `devcontainer postgres service`, `Discovery phase` (+18 more)
...
- **What connects `graphify Skill Trigger Config (.claude/CLAUDE.md)`, `graphify reference: github-and-merge.md`, `devcontainer app service` to the rest of the system?**
