  ...
  return (
    <div className="flex min-h-[100svh] flex-col px-5 pt-6 pb-5">
      <div className="mx-auto mb-3 flex flex-col items-center">
        ...
        <span className="font-heading text-[15px] font-bold text-text-h">must-be-the-stack</span>
      </div>
      <div className="mb-3 flex justify-center">
        <EntryIllustration />
      </div>
      <h1 className="my-2 text-center font-heading text-[23px] leading-[1.2] font-bold tracking-[-0.4px] text-text-h">
        {t("entry.title")}
      </h1>
      <p className="mb-6 text-center text-[12.5px]">{t("entry.subtitle")}</p>
