...
function SubjectPage() {
  ...
  switch (state.status) {
    ...
    case "ready": {
      ...
      const nextLockedLessonId = firstLockedId(subject.lessons);
        ...
        <div className="flex min-h-[100svh] flex-col px-5 pt-6 pb-5">
          ...
          <div className="mb-4 flex flex-col gap-2">
            {subject.lessons.map((lesson) => {
              const meta = lockStatusMeta(lesson.status, t("subjectDetail.lessonMeta"), lesson.score ?? undefined);
              // Unlike the Subject list, an active Lesson's icon is its position number.
